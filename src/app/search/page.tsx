  ...
  return (
    <PageShell>
      <div className="page-header mt-3">
        <p className="page-kicker" data-i18n="search.kicker">Pencarian</p>
        <h1 className="page-title" data-i18n="search.title">Cari Drama</h1>
        <p id="searchHint" className="page-subtitle" data-i18n="search.sub">Temukan drama dari berbagai platform dalam satu pencarian.</p>
      </div>
      ...
      <div className="mt-6">
        <div className="flex w-full gap-2">
          <form id="searchForm" autoComplete="off" className="search-input-wrap flex flex-1 items-center gap-2 pl-4 pr-2 transition-all" style={{ borderRadius: "500px", background: "var(--bg-raised)" }}>
            ...
            <input id="searchInput" type="search" name="q" placeholder="Cari drama, judul, kata kunci..." data-i18n-placeholder="search.placeholder" autoFocus className="flex-1 bg-transparent py-3 text-[15px] outline-none" style={{ color: "var(--text-primary)" }} />
      ...
      <Script id="page-search" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: `
        function _load(){var s=document.createElement('script');s.src='/js/search.js';document.body.appendChild(s);}
