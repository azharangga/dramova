...
export default function HistoryPage() {
  return (
    <PageShell>
      <PageHeader kicker="Riwayat" kickerI18n="library.kicker" title="Riwayat" titleI18n="library.title" subtitle="Kelola tontonan terakhir serta film dan serial favorit dalam satu tempat agar mudah melanjutkan tontonan berikutnya." subtitleI18n="library.sub" />
      ...
      <section className="mt-7">
        ...
        <div id="libraryEmpty" hidden className="mt-16 flex flex-col items-center justify-center text-center">
          ...
          <p className="mt-1.5 text-sm" style={{ color: "var(--text-secondary)" }} data-i18n="library.empty_sub">Mulai tonton film atau serial pertamamu di Beranda.</p>
